...
parser.add_argument('--log_prefix', type=str, default='quick_eval')
...
parser.add_argument("--eval_tasks", type=str, default="arc_easy,arc_challenge, piqa",
...
parser.add_argument("--e_bits_a", type=int, default=16, help="bits of weight")
parser.add_argument("--e_bits_w", type=int, default=16, help="bits of activation")
parser.add_argument("--s_bits", type=int, default=16, help="bits of shared")
...
parser.add_argument("--group_size", default=None, type=int, help='num of groups of data')
...
logger = utils.create_logger(output_dir, args)
