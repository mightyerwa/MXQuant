...
def create_logger(output_dir, args, dist_rank=0, name=''):
    ...
    if args.group_size is None:
        ...
        file_handler = logging.FileHandler(os.path.join(output_dir, f'log_{args.log_prefix}_sbits_{args.s_bits}_ebitsa_{args.e_bits_a}_ebitsw_{args.e_bits_w}_trainsize_{args.train_size}_group_size_{args.group_size}_ver{log_number}.txt'), mode='a')
